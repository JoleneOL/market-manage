...
//        Set<Login> levelLogin = levels.stream()
...
//                .stream()
//                // 来自我方系统推荐的
//                .filter(login -> login.getGuideUser() != null && levelLogin.contains(login.getGuideUser()))
...
//            return;
//        }
//        final Login from = login.getGuideUser();
//        if (from==null){
//            log.debug("引导人不存在，则不予建立关系");
//            return;
//        }
//        // 自己和自己的关联不用管
