...
$(function () {
    ...
    var table = $('#userTable').DataTable({
        ...
        "columns": [
            ...
            {
                "title": "创建时间", "data": "createdTime", "name": "createdTime"
            },
            {
                "title": "微信号码", "data": "wechatID", "name": "wechatID", "orderable": false
            },
            {
                "title": "等级", "data": "level", "name": "level"
            },
            {
            ...
            },
            {
                ...
                "orderable": false,
                data: function (item) {
                    var a = '<a href="javascript:;" class="js-edit" data-id="' + item.id + '"><i class="fa fa-check-circle-o"></i>&nbsp;查看</a>';
