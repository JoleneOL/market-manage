$(function () {
    ...
    function c() {
        ...
        if (k) {
            $(".J_menuTab.active").removeClass("active").removeAttr('data-original-title');
            var p = '<a href="javascript:;" class="active J_menuTab" data-toggle="tooltip" data-placement="bottom" title="双击Tab可刷新页面"  data-id="' + o + '">' + l + ' <i class="fa fa-times-circle"></i></a>';
