$(function () {
    ...
    function g(n) {
        ...
        $(".J_menuTab").tooltip('destroy');
        if ($(".J_menuTab.active").length > 0) {
            $(".J_menuTab.active").tooltip();
        }
    }
    ...
    function c() {
        ...
        if (k) {
            ...
            var p = '<a href="javascript:;" class="active J_menuTab" data-toggle="tooltip" data-placement="bottom" data-trigger="hover" title="双击Tab可刷新页面"  data-id="' + o + '">' + l + ' <i class="fa fa-times-circle"></i></a>';
