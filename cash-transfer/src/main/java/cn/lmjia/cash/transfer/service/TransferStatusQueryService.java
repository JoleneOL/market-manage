...
public interface TransferStatusQueryService {
     ...
     */
    CashTransferResult statusQuery(EntityOwner owner , CashTransferSupplier supplier, String fBank, CashReceiver receuver) throws TransferFailureException, BadAccessException,JsonProcessingException;
}
